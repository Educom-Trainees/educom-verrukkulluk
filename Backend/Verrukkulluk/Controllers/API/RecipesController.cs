...
namespace Verrukkulluk.Controllers.API
{
    ...
    public class RecipesController : ControllerBase
    {
        ...
        public IActionResult PutRecipe(int id, RecipeDTO recipeDTO)
        {
            ...
            if (recipe == null)
            {
                return NotFound("No recipe with this id found");
            }
            _mapper.Map(recipeDTO, recipe);
            try
            {
                int previousImageObjId = recipe.ImageObjId;
            ...
            {
                _logger.LogError(e, "Update recipe {recipeDTO.Name} failed", recipeDTO.Title);
